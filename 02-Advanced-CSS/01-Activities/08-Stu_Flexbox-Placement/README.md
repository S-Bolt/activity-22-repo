...
* As a user, I want the navigation links to be on the right side. (Justyfiy-content: flex-end or flex-direction: row-reverse.)

* As a user, I want the slideshow buttons to be sized as smaller icons and centered alongside the image. (align-items:center)
