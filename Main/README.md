...
As a client, I want the landing page to have a poll about following questions 1. Create a section for first poll a. Pick services requested using checkboxes [volunteer, professional services, board representation, group events] 2. Create a section for this. Select your preferred region of service [Use radio button here] a. East US, West US, Mexico, APAC

As a client, I want the landing page to have a polished and accessible UI.

Acceptance Criteria
It's done when the page uses semantic HTML elements.g
